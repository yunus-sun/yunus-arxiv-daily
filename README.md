...
|---|---|---|---|---|
|**2025-02-14**|**(How) Can Transformers Predict Pseudo-Random Numbers?**|Tao Tao et.al.|[2502.10390](http://arxiv.org/abs/2502.10390)|null|
...
|**2025-02-14**|**CISSIR: Beam Codebooks with Self-Interference Reduction Guarantees for Integrated Sensing and Communication Beyond 5G**|Rodrigo Hernangómez et.al.|[2502.10371](http://arxiv.org/abs/2502.10371)|**[link](https://github.com/rodrihgh/cissir)**|
...
|**2025-02-14**|**Learning Euler Factors of Elliptic Curves**|Angelica Babei et.al.|[2502.10357](http://arxiv.org/abs/2502.10357)|null|
...
|**2025-02-14**|**Ocular Disease Classification Using CNN with Deep Convolutional Generative Adversarial Network**|Arun Kunwar et.al.|[2502.10334](http://arxiv.org/abs/2502.10334)|null|
|**2025-02-14**|**A Graph-Based Iterative Strategy for Solving the All-Line Transmission Switching Problem**|Marina Aguilar-Moreno et.al.|[2502.10333](http://arxiv.org/abs/2502.10333)|null|
|**2025-02-14**|**Analysis and Prediction of Coverage and Channel Rank for UAV Networks in Rural Scenarios with Foliage**|Donggu Lee et.al.|[2502.10324](http://arxiv.org/abs/2502.10324)|null|
...
|Publish Date|Title|Authors|PDF|Code|
|---|---|---|---|---|
|**2025-02-13**|**Euclid: Finding strong gravitational lenses in the Early Release Observations using convolutional neural networks**|B. C. Nagam et.al.|[2502.09802](http://arxiv.org/abs/2502.09802)|null|
...
|**2025-02-14**|**Self-Normalized Inference in (Quantile, Expected Shortfall) Regressions for Time Series**|Yannick Hoga et.al.|[2502.10065](http://arxiv.org/abs/2502.10065)|null|
|**2025-02-14**|**Exploring Neural Granger Causality with xLSTMs: Unveiling Temporal Dependencies in Complex Data**|Harsh Poonia et.al.|[2502.09981](http://arxiv.org/abs/2502.09981)|null|
...
|**2025-02-14**|**Comprehensive Review of Neural Differential Equations for Time Series Analysis**|YongKyung Oh et.al.|[2502.09885](http://arxiv.org/abs/2502.09885)|null|
|**2025-02-14**|**Interpretable Early Warnings using Machine Learning in an Online Game-experiment**|Guillaume Falmagne et.al.|[2502.09880](http://arxiv.org/abs/2502.09880)|null|
...
|**2025-02-13**|**Then and now: A new look at the eclipse timing variations of hierarchical triple star candidates in the primordial $Kepler$ -field, revisited by TESS**|T. Borkovits et.al.|[2502.09480](http://arxiv.org/abs/2502.09480)|null|
...
|**2025-02-13**|**Capitalizing on a Crisis: A Computational Analysis of all Five Million British Firms During the Covid-19 Pandemic**|Naomi Muggleton et.al.|[2502.09383](http://arxiv.org/abs/2502.09383)|null|
...
|**2025-02-14**|**DesignWeaver: Dimensional Scaffolding for Text-to-Image Product Design**|Sirui Tao et.al.|[2502.09867](http://arxiv.org/abs/2502.09867)|null|
...
|**2025-02-13**|**"Ronaldo's a poser!": How the Use of Generative AI Shapes Debates in Online Forums**|Yuhan Zeng et.al.|[2502.09693](http://arxiv.org/abs/2502.09693)|null|
...
|**2025-02-13**|**Assessing Generative AI value in a public sector context: evidence from a field experiment**|Trevor Fitzpatrick et.al.|[2502.09479](http://arxiv.org/abs/2502.09479)|null|
