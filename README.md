...
|**2025-04-14**|**Measuring amount of computation done by C.elegans using whole brain neural activity**|Junang Li et.al.|[2504.10300](http://arxiv.org/abs/2504.10300)|null|
|**2025-04-14**|**Spectral estimation for high-dimensional linear processes**|Jamshid Namdari et.al.|[2504.10257](http://arxiv.org/abs/2504.10257)|null|
|**2025-04-14**|**Dissimilar magnetically driven accretion on the components of V4046 Sagittarii**|Kim Pouilly et.al.|[2504.10217](http://arxiv.org/abs/2504.10217)|null|
...
|**2025-04-14**|**Impact of rainfall risk on rice production: realized volatility in mean model**|Soham Ghosh et.al.|[2504.10121](http://arxiv.org/abs/2504.10121)|null|
...
|**2025-04-14**|**AimTS: Augmented Series and Image Contrastive Learning for Time Series Classification**|Yuxuan Chen et.al.|[2504.09993](http://arxiv.org/abs/2504.09993)|null|
...
|Publish Date|Title|Authors|PDF|Code|
|---|---|---|---|---|
|**2025-04-14**|**Continuous fields of interval algebras**|Laurent Cantier et.al.|[2504.10328](http://arxiv.org/abs/2504.10328)|null|
|**2025-04-14**|**Struggle First, Prompt Later: How Task Complexity Shapes Learning with GenAI-Assisted Pretesting**|Mahir Akgun et.al.|[2504.10249](http://arxiv.org/abs/2504.10249)|null|
|**2025-04-14**|**StePO-Rec: Towards Personalized Outfit Styling Assistant via Knowledge-Guided Multi-Step Reasoning**|Yuxi Bi et.al.|[2504.09915](http://arxiv.org/abs/2504.09915)|null|
...
|**2025-04-14**|**"All Roads Lead to ChatGPT": How Generative AI is Eroding Social Interactions and Student Learning Communities**|Irene Hou et.al.|[2504.09779](http://arxiv.org/abs/2504.09779)|null|
...
|**2025-04-12**|**Confirmation Bias in Generative AI Chatbots: Mechanisms, Risks, Mitigation Strategies, and Future Research Directions**|Yiran Du et.al.|[2504.09343](http://arxiv.org/abs/2504.09343)|null|
